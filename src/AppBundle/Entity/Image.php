...
class Image
{
    ...
    /**
    * @var bool
    * @ORM\Column(name="isStarBack", type="boolean")
    */
    private $isStarBack;
    ...
    */
     ...
     * Set isStarBack
     *
     * @param boolean $isStarBack
     *
     * @return Image
     */
    public function setIsStarBack($isStarBack)
    {
        $this->isStarBack = $isStarBack;
        return $this;
    }
     ...
     * @return bool
     */
    public function getIsStarBack()
    {
        return $this->isStarBack;
    }
